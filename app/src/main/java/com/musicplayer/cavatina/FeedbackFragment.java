...
public class FeedbackFragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       tvt1.setText("Problems ? Feedback ?\n \n" +"The more you tell us, the better Cavatina will be."+" Since this audio player" +
      ...
      Typeface tf3 = Typeface.createFromAsset(getActivity().getAssets(), "fonts/constanz.ttf");
       ...
       String linkText = "Write to us :  <a href='https://docs.google.com/forms/d/181HC4983m0VkGye-l6j2lu19uFRygSjhlESZ8DTnCjY/viewform'>Feedback@Cavatina</a> ";

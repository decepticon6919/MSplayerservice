...
import com.musicplayer.cavatina.AlbumFragment.onclick1;
import com.musicplayer.cavatina.ArtistFragment.onclick3;
import com.musicplayer.cavatina.MusicService.MusicBinder;
import com.musicplayer.cavatina.PlaylistFragment.onclick2;
import com.musicplayer.cavatina.SongFragment.onclick;

import java.util.ArrayList;
import java.util.TreeSet;

public class MainActivity extends Activity implements MediaPlayerControl ,onclick,onclick1,onclick2,onclick3,LoaderCallbacks<Cursor> {
	...
	private void displayView(int position) {
		...
		LayoutInflater li1 = LayoutInflater.from(this); 
           ...
           alertDialogBuilder.setView(view1).setTitle(" Playlists").setIcon(R.drawable.album);        
          // create alert dialog 
		...
		case 2:      
		        ...
		        getLoaderManager().initLoader(0, null,this);
		         ...
		         AlertDialog.Builder alertDialogBuilder1 = new AlertDialog.Builder(this,AlertDialog.THEME_TRADITIONAL);
	                alertDialogBuilder1.setView(view).setTitle("Albums").setIcon(R.drawable.album);		          
		         //create alert dialog 
        ...
        // Customloader cr = new Customloader();
         ...
         AlertDialog.Builder alertDialogBuilder3 = new AlertDialog.Builder(this,AlertDialog.THEME_TRADITIONAL); 
            alertDialogBuilder3.setView(view3).setTitle("Artists").setIcon(R.drawable.album);         
          // create alert dialog 
